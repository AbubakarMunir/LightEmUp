...
//		FB.LogAppEvent(eventName);
	...
	//public const string World = "SuperBroRun";
    ...
    public static void MissionOrLevelStartedEventLog(string GameMode, int LevelNumber)
    {
        ...
        GameAnalytics.NewProgressionEvent(GAProgressionStatus.Start, GameMode, "Level" + LevelNumber);
    ...
    public static void MissionOrLevelFailEventLog(string GameMode, int LevelNumber)
    {
        ...
        GameAnalytics.NewProgressionEvent(GAProgressionStatus.Fail, GameMode, "Level" + LevelNumber);
    ...
    public static void MissionOrLevelCompletedEventLog(string GameMode, int LevelNumber)
    {
        ...
        GameAnalytics.NewProgressionEvent(GAProgressionStatus.Complete, GameMode, "Level" + LevelNumber);
